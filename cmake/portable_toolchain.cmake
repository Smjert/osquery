...
if(OSQUERY_PORTABLE_TOOLCHAIN_SYSROOT)
  overwrite_cache_variable("CMAKE_C_COMPILER" "FILEPATH" "${OSQUERY_PORTABLE_TOOLCHAIN_SYSROOT}/usr/bin/clang")
  overwrite_cache_variable("CMAKE_CXX_COMPILER" "FILEPATH" "${OSQUERY_PORTABLE_TOOLCHAIN_SYSROOT}/usr/bin/clang++")
