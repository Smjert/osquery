...
extensions_result.thrift_spec = (
    (0, TType.MAP, 'success', (TType.I64, None, TType.STRUCT, [InternalExtensionInfo, None], False), None, ),  # 0
)
...
options_result.thrift_spec = (
    (0, TType.MAP, 'success', (TType.STRING, None, TType.STRUCT, [InternalOptionInfo, None], False), None, ),  # 0
)
...
registerExtension_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'info', [InternalExtensionInfo, None], None, ),  # 1
    (2, TType.MAP, 'registry', (TType.STRING, None, TType.MAP, (TType.STRING, None, TType.LIST, (TType.MAP, (TType.STRING, None, TType.STRING, None, False), False), False), False), None, ),  # 2
)
...
registerExtension_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ExtensionStatus, None], None, ),  # 0
)
...
query_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ExtensionResponse, None], None, ),  # 0
)
